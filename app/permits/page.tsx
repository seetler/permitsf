...
const permits = [
  { id: "PRM-2024-001", name: "Business License - Food Truck", department: "Business Licensing", status: "pending", submittedDate: "2024-01-28", lastUpdated: "2024-01-28" },
  { id: "PRM-2024-002", name: "Building Permit - Deck Construction", department: "Building & Safety", status: "approved", submittedDate: "2024-01-15", lastUpdated: "2024-01-20" },
  { id: "PRM-2024-003", name: "Electrical Permit - Kitchen Renovation", department: "Electrical Division", status: "under-review", submittedDate: "2024-01-22", lastUpdated: "2024-01-25" },
  { id: "PRM-2024-004", name: "Plumbing Permit - Bathroom Remodel", department: "Plumbing Division", status: "rejected", submittedDate: "2024-01-10", lastUpdated: "2024-01-18" },
]
...
export default function PermitsPage() {
  ...
  if (!isLoaded) {
    return (
      <div className="p-6 pt-16 md:pt-6 flex items-center justify-center h-full">
  ...
  return (
    <div className="relative">
      {!isPaid && <PaywallModal onClose={() => router.push("/hugo")} />}

      <div className={`p-6 pt-16 md:pt-6 ${!isPaid ? "blur-sm pointer-events-none" : ""}`}>
        <div className="mb-8">
